...
function(a, b) {
    ...
    f.pt.creat = function() {
        ...
        case 0:
            ...
            break;
        case 2:
            var h = b.content = i ? b.content: [b.content || "http://www.lanyuanoss.com/lanyuan.shtml?from=layer", "auto"];
            var fid = g[4] + f;
            if(b.id!=''&&b.id!==undefined)
            fid=b.id;
            b.content = '<iframe scrolling="' + (b.content[1] || "auto") + '" allowtransparency="true" id="' + fid + '" name="' + g[4] + f + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + b.content[0] + '"></iframe>';
            break;
        case 3:
            b.title = !1,
            b.closeBtn = !1,
    ...
    layer.style = function(a, b) {
        ...
        (d.css(b)
            ,f === e.type[1]&&d.find('.'+g[5]).css({height: parseFloat(b.height) - h - i})
            ,f === e.type[2] && d.find("iframe").css({height: parseFloat(b.height) - h - i}))
    },
